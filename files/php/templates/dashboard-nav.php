<div class="sidebar p-3 border-end">
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
            <a href="statistics.php" class="nav-link <?php echo($page == "statistics" ? "active" : "link-dark"); ?>">
        ...
        <li>
            <a href="#" class="nav-link <?php echo($page == "weatherStation" ? "active" : "link-dark"); ?>" onclick="alert('Coming Soon');">
        ...
        <li>
            <a href="add-system.php" class="nav-link <?php echo($page == "add-system" ? "active" : "link-dark"); ?>">
